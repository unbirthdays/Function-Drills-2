...
const contains = (array, name, cb) => { if (array.includes(name)) {
  cb(true);
} else {
  cb(false);
}
...
const each = (array, cb) => array.forEach((e, i) => cb(e, i));
...
const addingFactory = num => innerFunc = num2 => num + num2;
...
const addFortyTwo = addingFactory(42);
